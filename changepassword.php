...
<UL>
  <LI>Cookies must be enabled beyond this point.</LI>
	...
	<form method="post" action="">
		...
		<center><input type="password" name="o_password" class="input"/></center><br />
		<label>New password:</label>
       <center> <input type="password" name="n_password" class="input"/></center><br />
		<label>Confirm New password:</label>
       <center> <input type="password" name="c_n_password" class="input"/></center><br />
